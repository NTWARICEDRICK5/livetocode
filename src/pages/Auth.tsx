...
import { Code2, Mail, Lock, Loader2, MailCheck } from "lucide-react";
...
const AuthPage = () => {
  ...
  const subtitle =
    mode === "signin"
      ? "Sign in to keep your XP, streaks and progress"
      : mode === "signup"
      ? "Start learning from zero — no experience needed"
          ...
          {sent ? (
            <div className="text-center space-y-4">
              ...
              <button
                ...
                className="w-full px-4 py-2.5 rounded-lg bg-gradient-primary text-primary-foreground font-semibold"
              >
                Back to sign in
              </button>
            </div>
